      ...
      if (!mindMap || !mindMap.nodes || mindMap.nodes.length === 0) {
        return (
          <div className="empty-state-card">
            ...
            <p>Knowledge Map Coming Soon</p>
            <p className="empty-hint">Create 3+ notes to generate a visual knowledge map showing connections between your ideas.</p>
          </div>
        );
      }
    ...
    return (
      <div className="mindmap-view">
        <div className="mindmap-header">
          <div>
            <h2>Knowledge Map</h2>
            <p className="mindmap-subtitle">Visualize semantic connections between your notes and concepts</p>
          </div>
          <div className="notes-stats">
            <div className="stat-pill">🧠 {notes.length} notes</div>
          </div>
        </div>
